...
import type { JokeSearchResponse } from '../utils/api'
...
const PaginationItem = ({ query, page, active }: PaginationItemProps) => {
  if (active) {
    return (
...
const Search = () => {
  ...
  const [searchResult, setSearchResult] = useState<JokeSearchResponse>(null)
